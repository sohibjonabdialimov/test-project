    ...
    <footer className="bg-[#0054AE] text-[#fff]">
      <div className="footer_content w-[1400px] mx-auto grid grid-cols-4 pt-10 pb-12">
        <ul className="flex flex-col gap-2">
          ...
          <li>
            <Link href={"/"}>{t("footer_1_3")}</Link>
          </li>
          <li>
            <Link href={"/"}>{t("footer_1_4")}</Link>
          </li>
          <li>
            <Link href={"/"}>{t("footer_1_5")}</Link>
          </li>
          <li>
            <Link href={"/"}>{t("footer_1_6")}</Link>
          </li>
        </ul>
        <ul className="flex flex-col gap-2">
          <li>
          ...
          <li>
            <Link href={"/"}>{t("footer_2_3")}</Link>
          </li>
          <li>
            <Link href={"/"}>{t("footer_2_4")}</Link>
          </li>
          <li>
            <Link href={"/"}>{t("footer_2_5")}</Link>
          </li>
          <li>
            <Link href={"/"}>{t("footer_2_6")}</Link>
          </li>
        </ul>
        <ul className="flex flex-col gap-2">
          <li>
          ...
          <li>
            <Link href={"/"}>{t("footer_3_3")}</Link>
          </li>
          <li>
            <Link href={"/"}>{t("footer_3_4")}</Link>
          </li>
        </ul>
        <ul className="flex flex-col gap-2">
          <li>
      ...
      <div className="w-[1400px] mx-auto flex items-center py-8">
        ...
        <div className="justify-items-end pr-5">
          <p className="text-sm font-normal">{t("footer_b_1")}</p>
